...
lang2model_name = { 'am' : 'Davlan/xlm-roberta-base-finetuned-amharic',
                    'ha' : 'Davlan/xlm-roberta-base-finetuned-hausa' , 
                    'ma' : 'SI2M-Lab/DarijaBERT',

                    'ig' : 'Davlan/xlm-roberta-base-finetuned-igbo',
                    'yo' : 'Davlan/bert-base-multilingual-cased-finetuned-yoruba',
                    'pcm': 'Davlan/bert-base-multilingual-cased-finetuned-naija', 
                    'dz' : 'alger-ia/dziribert', 
                    'pt' : 'neuralmind/bert-base-portuguese-cased',
                    'sw' : 'Davlan/xlm-roberta-base-finetuned-swahili',
                    'kr' : 'Davlan/bert-base-multilingual-cased-finetuned-kinyarwanda',
                    'twi':'Ghana-NLP/abena-base-akuapem-twi-cased',
                   }
...
def main(lang):
    ...
    if lang in lang2model_name:
        MODEL = lang2model_name[lang]
        ...
        training_args = TrainingArguments(
            output_dir='./results_fine/{}'.format(lang),                   # output directory
        ...
        trainer.save_model("./results_fine/{}/best_model".format(lang))
        tokenizer.save_pretrained("./results_fine/{}/best_model".format(lang))

        test_preds_raw, test_labels , _ = trainer.predict(val_dataset)
        test_preds = np.argmax(test_preds_raw, axis=-1)
        print(classification_report(test_labels, test_preds, digits=3))

        with open("./results_fine/{}/best_model_results.txt".format(lang), 'wt') as fp:        
